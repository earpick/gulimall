...
import com.study.common.utils.ProductConstant;
...
public class AutoFillConfig implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        if (metaObject.hasSetter(ProductConstant.INSERT_FILE_NAME)) {
            this.setFieldValByName(ProductConstant.INSERT_FILE_NAME, getDateValue(), metaObject);
        }

        if (metaObject.hasSetter(ProductConstant.UPDATE_FILE_NAME)) {
            this.setFieldValByName(ProductConstant.UPDATE_FILE_NAME, getDateValue(), metaObject);
        }
    ...
    private Object getDateValue() {
        try {
            // 时间格式化
            DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern(ProductConstant.TIME_FORMAT);
