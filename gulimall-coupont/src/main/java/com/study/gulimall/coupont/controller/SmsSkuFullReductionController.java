 ...
 */
@RestController
@RequestMapping("coupont/smsskufullreduction")
public class SmsSkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupont:smsskufullreduction:list")
    ...
    //@RequiresPermissions("coupont:smsskufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupont:smsskufullreduction:save")
    ...
    //@RequiresPermissions("coupont:smsskufullreduction:update")
    ...
    //@RequiresPermissions("coupont:smsskufullreduction:delete")
