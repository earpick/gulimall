...
import com.study.gulimall.coupont.service.SmsHomeSubjectService;
 ...
 */
@RestController
@RequestMapping("coupont/smshomesubject")
public class SmsHomeSubjectController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupont:smshomesubject:list")
    ...
    //@RequiresPermissions("coupont:smshomesubject:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupont:smshomesubject:save")
    ...
    //@RequiresPermissions("coupont:smshomesubject:update")
    ...
    //@RequiresPermissions("coupont:smshomesubject:delete")
