...
import com.study.gulimall.coupont.service.SmsHomeAdvService;
 ...
 */
@RestController
@RequestMapping("coupont/smshomeadv")
public class SmsHomeAdvController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupont:smshomeadv:list")
    ...
    //@RequiresPermissions("coupont:smshomeadv:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupont:smshomeadv:save")
    ...
    //@RequiresPermissions("coupont:smshomeadv:update")
    ...
    //@RequiresPermissions("coupont:smshomeadv:delete")
