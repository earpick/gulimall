 ...
 */
@RestController
@RequestMapping("coupont/smscouponhistory")
public class SmsCouponHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupont:smscouponhistory:list")
    ...
    //@RequiresPermissions("coupont:smscouponhistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupont:smscouponhistory:save")
    ...
    //@RequiresPermissions("coupont:smscouponhistory:update")
    ...
    //@RequiresPermissions("coupont:smscouponhistory:delete")
