 ...
 */
@RestController
@RequestMapping("coupont/smsseckillskunotice")
public class SmsSeckillSkuNoticeController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupont:smsseckillskunotice:list")
    ...
    //@RequiresPermissions("coupont:smsseckillskunotice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupont:smsseckillskunotice:save")
    ...
    //@RequiresPermissions("coupont:smsseckillskunotice:update")
    ...
    //@RequiresPermissions("coupont:smsseckillskunotice:delete")
