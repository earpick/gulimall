...
import com.study.gulimall.coupont.service.SmsCouponSpuRelationService;
 ...
 */
@RestController
@RequestMapping("coupont/smscouponspurelation")
public class SmsCouponSpuRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupont:smscouponspurelation:list")
    ...
    //@RequiresPermissions("coupont:smscouponspurelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupont:smscouponspurelation:save")
    ...
    //@RequiresPermissions("coupont:smscouponspurelation:update")
    ...
    //@RequiresPermissions("coupont:smscouponspurelation:delete")
