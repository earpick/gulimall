...
import com.study.gulimall.coupont.service.SmsSeckillSkuRelationService;
 ...
 */
@RestController
@RequestMapping("coupont/smsseckillskurelation")
public class SmsSeckillSkuRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupont:smsseckillskurelation:list")
    ...
    //@RequiresPermissions("coupont:smsseckillskurelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupont:smsseckillskurelation:save")
    ...
    //@RequiresPermissions("coupont:smsseckillskurelation:update")
    ...
    //@RequiresPermissions("coupont:smsseckillskurelation:delete")
